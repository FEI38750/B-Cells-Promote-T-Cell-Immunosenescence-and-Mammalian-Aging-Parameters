...
niches = list(
  "Aged_niche" = list(
    "sender" = c("Aged_B_Cells"),
    "receiver" = c("Aged_T_Cells")),
  "Young_niche" = list(
    "sender" = c("Young_B_Cells"),
    "receiver" = c("Young_T_Cells"))
...
ggsave("B2T_exprs_activity_target_plot.pdf", width = 24, height = 10)
...
ggsave("B2T_circos_output.pdf", width = 10, height = 10)
