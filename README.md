...
7. *PICseq_PICs_vs_AD.R* Generate dataframe of young and aged artificial doublets (AD) and true PICs for DEG analysis.
8. *GeoMx_code_Spleen.rtf:* Code for processing GeoMx data.
